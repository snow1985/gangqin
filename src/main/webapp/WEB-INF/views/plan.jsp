  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="plan_update_btn">保存</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="empAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
        <button type="button" class="btn btn-primary" id="plan_save_btn">保存</button>
      </div>
    </div>
  </div>
</div>
...
<div class="container">
	   ...
	   var totalRecord;
	      ...
	      //向页面添加员工信息及样式
	  	function build_plan_table(result){
    ...
    function getPlan(id) {
        $(id).empty();
          $.ajax({
             url:"${base_path}/plan/"+id,
             type:"GET",
              success:function(result){
              	
                 var planDate=result.extend.plan;
                 $("#startdate_update_input").val(planDate.startdate);
                 $("#enddate_update_input").val(planDate.enddate);
                 $("#plan_update_input").val(planDate.plan);
                 $("#empUpdateModal input[name=state]").val([planDate.state]);
